...
<body>
    ...
    <?php 
        if (@$_POST["submit"]) {
            ...
            $sqlEkleBlog = "INSERT INTO blog SET baslik = ?, alt_baslik = ?, aciklama = ?, aktif = ?";
            $ekleBlog = $db -> prepare($sqlEkleBlog);
            $sonucEkleBlog = $ekleBlog -> execute(array(
                $baslik,
                $alt_baslik,
                $aciklama,
                $aktif
            ...
            if ($sonucEkleBlog) {
                echo "<script>alert('İşleminiz Başarıyla Gerçekleşmiştir.'); window.location.href='blog.php'</script>";
            }else {
                echo "<script>alert('İşleminiz Başarısız Olmuştur.'); window.location.href='blog.php'</script>";
            }
        }
    ?>    
                                ...
                                <div class="col-lg-12">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="mytextarea" name="aciklama"></textarea>
                                        </div>
