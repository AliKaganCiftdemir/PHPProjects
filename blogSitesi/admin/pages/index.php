...
<body>
    ...
    <?php 
        if (@$_POST["submit"]) {
            ...
            if ($_POST["username"] == "admin" && $md5Sifre == "905fed16367ac5f65922da066223aeeb") {
                $_SESSION["girisKontrol"] = 1;
                $_SESSION["username"] = $_POST["username"];
                echo "<script>alert('Giriş İşlemi Başarılı.'); window.location.href='anasayfa.php'</script>";
                return true;
            }else {
                echo "<script>alert('Giriş İşlemi Başarısız.'); window.location.href='index.php'</script>";
                return false;
            }
        }
    ?> 
